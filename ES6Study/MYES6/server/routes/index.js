...
var makeIssue=function(){
	...
	var end_issue_date=new Date(first_issue_date.getTime()+77*10*60*1000);   //截止时间
	...
	if(end_time-cur_date.getTime()>1000*60*2){    //最后的10分钟
		state='正在销售'    		//前8分钟销售
	}else{
		state='开奖中'         //后2分钟开奖
	}
